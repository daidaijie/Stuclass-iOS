...
- (void)drawRect:(CGRect)rect{
    ...
    UIRectFrame(CGRectMake(widthSpan - 2, 0, self.cropSize.width + 4, self.cropSize.height + 4));
    
    //fill inner rect
    [[UIColor clearColor] set];
    UIRectFill(CGRectMake(widthSpan, 2, self.cropSize.width, self.cropSize.height));
