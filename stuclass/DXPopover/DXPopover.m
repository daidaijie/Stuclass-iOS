...
- (void)commonInit {
    ...
    self.arrowSize = CGSizeMake(18.0, 9.0);
    self.cornerRadius = 5.0;
    self.backgroundColor = [UIColor colorWithRed:0.745 green:0.298 blue:0.235 alpha:1.000];
...
- (void)showAtPoint:(CGPoint)point
    ...
    contentWidth = CGRectGetWidth(contentView.bounds);
    CGFloat contentHeight;
    contentHeight = CGRectGetHeight(contentView.bounds);
    CGFloat containerWidth;
    containerWidth = CGRectGetWidth(containerView.bounds);
    CGFloat containerHeight;
    containerHeight = CGRectGetHeight(containerView.bounds);
